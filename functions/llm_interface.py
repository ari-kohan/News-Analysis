...
from data_ingestors.data import NewsAnalysis, NewsData
...
INFORMATION_EXTRACTION_TEMPLATE = ChatPromptTemplate.from_template(
    ...
    If no information relevant to a category is present in the text, store the value as an empty list []
    Text:
    {text}
    """
)
...
if __name__ == "__main__":
    with open("rss_feed_0.json") as file:
