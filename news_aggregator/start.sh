...
# Start Celery worker
start_process "Celery worker" "celery -A app worker --loglevel=info --logfile=logs/celery_worker.log"

# Start Celery beat
start_process "Celery beat" "celery --A app beat --loglevel=info --logfile=logs/celery_worker.log"
